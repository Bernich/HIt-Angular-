...
export class HiveAdminAddInstructorComponent implements OnInit {
  ...
  update() {
    const instructor: CreateUpdateInstructorDTO =
      InstructorMapper.convertToUpdateDTO(this.user);

    this.instructorService
      .updateInstructor(this.user.instructor_id, instructor)
      .subscribe(
        (iuser: any) => {
          this.isLoading = false;
