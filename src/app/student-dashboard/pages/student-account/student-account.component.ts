...
import { IUpdateUser, IUser } from 'src/app/shared/models/user.model';
import { AuthService } from 'src/app/shared/services/auth.service';
import { UsersService } from 'src/app/shared/services/users.service';

/** StudentAccountComponent - Shows the activities that can be performed on a student account*/
@Component({
...
export class StudentAccountComponent implements OnInit {
  ...
  /**
   * Constructs the StudentAccountComponent with the following injected services
